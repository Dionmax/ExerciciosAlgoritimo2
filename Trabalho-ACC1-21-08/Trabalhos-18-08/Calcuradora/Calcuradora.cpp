...
void menu()
{
	...
	do
	{
		...
		{
		case 1:
			cout << "Resultado da operação: " << adicao(numero_um, numero_dois);
			break;

		case 2:
			cout << "Resultado da operação: " << subtracao(numero_um, numero_dois);
			break;

		case 3:
			cout << "Resultado da operação: " << multiplicacao(numero_um, numero_dois);
			break;

		case 4:
			cout << "Resultado da operação: " << divisao(numero_um, numero_dois);
			break;

		case 5:
			cout << "Resultado da operação: " << potencia(numero_um, numero_dois);
			break;
